...
* Point to the adherents of other religions, like the Buddhists or the famously pacifistic and environmentally conscious Jainists to show that non-Christians can be moral. 
* Point to a few examples of completely atheistic societies, such as the Piraha in the Amazon basin, as an example of people who manage to live peacefully without belief in a deity; or to various secular charities, many of whose members are atheists and do good simply because it's good. 
* Finally, point to non-human species such as bonobos and chimpanzees that demonstrate moral behavior such as altruism, selflessness, fairness, an aversion to killing and so on - while demonstratably never having read the Bible.
