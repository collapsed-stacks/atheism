...
* is [Sentient](http://en.wikipedia.org/wiki/Sentient)
* is or will be [Sapient](http://en.wikipedia.org/wiki/Sapience)
* has or will have the ability to act with intent
* can or will be able to demonstrate meta-cognition (the ability to think about "thinking")
* has the capacity for language
...
But as an abstraction over feelings, temperament, experiences, thoughts, nerves and wisdom, it might be useful. 
 ...
 2. Why and how do we threat people different than animals? 
...
* Does the species exhibit the capacity to self-identify? IE, can it recognize itself in a mirror or similar object?  Does is demonstrate an awareness of self?
* Does it demonstrate a capacity for planning and the execution of plans that go beyond a simple hand-to-mouth or hunt and kill capacity?
* Does it demonstrate an ability to organize with its peers in order to achieve its goals?
* Does it use language?  Can it interact with language beyond the level of simple verbal cues?
